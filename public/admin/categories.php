...
<main class="container mx-auto flex justify-center flex-col items-center">
    ...
    <table class="w-full text-sn text-left rtl:text-right text-gray-500 max-w-xl mb-10">
        ...
        <?php foreach ( $categories as $category ): ?>
            <tr class="bg-white border-b dark:bg-gray-800">
                ...
                <td class="px-6 py-4 font-medium text-blue-600 whitespace-nowrap"><a href="category-delete.php?id=<?php echo $category['id'] ?>">Delete</a></td>
            </tr>
        <?php endforeach ?>
        </tbody>
    </table>
